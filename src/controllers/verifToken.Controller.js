                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse text-justify" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <a class="nav-link" style="color:#5E2D14;border-color: #5E2D14;border-right-style: solid;border-left-style: solid;" href="/">Petish Account Verification</a>
                            </li>
                        </ul>
                    </div>
                </nav>
            ...
            <div class="container text-center">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        <h1 style="color:#5E2D14">Account Verified Successfully</h1>
                        <p style="color:#5E2D14">Thank you for verifying your account. You can now login to your account.</p>
                    </div>
    ...
    <div class="footer">
        <div class="container"  id="footersec">
            <div class="row">
                ...
                <div class ="col-4 text-center" style="border-style:solid ;border-color: #5E2D14;margin-top: 10px; margin-bottom: 10px;">
